...
// Local copy of the go-tc-counter BPF program for e2e testing.
// Identical map layout to quay.io/bpfman-bytecode/go-tc-counter so
// that tests reading tc_stats_map work unchanged.
