...
[tutorial.md](./tutorial.md) will guide you through deploying `bpfd`.
...
The [tutorial.md](./tutorial.md) guide describes the different modes `bpfd` can be run in.
...
[shipping-bytecode.md](./shipping-bytecode.md).
...
[shipping-bytecode.md](./shipping-bytecode.md) provides detailed instructions on
