...
static volatile const struct xdp_dispatcher_config conf2 = {};
static volatile const struct xdp_dispatcher_config conf3 = {};
...
int xdp_dispatcher(struct xdp_md *ctx)
{
        ...
        __u8 num_progs_enabled2 = conf2.num_progs_enabled;
        __u8 num_progs_enabled3 = conf3.num_progs_enabled;
        int ret;
