...
example, release version 0.5.5 is tagged as v0.5.5.
...
version (e.g., `CHANGELOG-v0.5.5.md`).
...
1. Summary of the major changes and highlights. For example: "The v0.5.5 release
...
- Make the following changes
    ...
    - Search the code and docs for the current version number without the "v"
      (e.g., 0.5.5) and replace it with the new version number where it makes
...
- After the PR is reviewed, merged, and all GitHub actions have completed
  successfully, tag the release with the version number (e.g., v0.5.5).
