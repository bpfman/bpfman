...
func (c *FakeUprobePrograms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UprobeProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(uprobeprogramsResource, name), &v1alpha1.UprobeProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.UprobeProgram), err
}
...
func (c *FakeUprobePrograms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UprobeProgramList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(uprobeprogramsResource, uprobeprogramsKind, opts), &v1alpha1.UprobeProgramList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.UprobeProgramList{ListMeta: obj.(*v1alpha1.UprobeProgramList).ListMeta}
	for _, item := range obj.(*v1alpha1.UprobeProgramList).Items {
...
func (c *FakeUprobePrograms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(uprobeprogramsResource, opts))
}
...
func (c *FakeUprobePrograms) Create(ctx context.Context, uprobeProgram *v1alpha1.UprobeProgram, opts v1.CreateOptions) (result *v1alpha1.UprobeProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(uprobeprogramsResource, uprobeProgram), &v1alpha1.UprobeProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.UprobeProgram), err
...
func (c *FakeUprobePrograms) Update(ctx context.Context, uprobeProgram *v1alpha1.UprobeProgram, opts v1.UpdateOptions) (result *v1alpha1.UprobeProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(uprobeprogramsResource, uprobeProgram), &v1alpha1.UprobeProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.UprobeProgram), err
...
func (c *FakeUprobePrograms) UpdateStatus(ctx context.Context, uprobeProgram *v1alpha1.UprobeProgram, opts v1.UpdateOptions) (*v1alpha1.UprobeProgram, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(uprobeprogramsResource, "status", uprobeProgram), &v1alpha1.UprobeProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.UprobeProgram), err
...
func (c *FakeUprobePrograms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(uprobeprogramsResource, name, opts), &v1alpha1.UprobeProgram{})
	return err
}
...
func (c *FakeUprobePrograms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(uprobeprogramsResource, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.UprobeProgramList{})
	return err
}
...
func (c *FakeUprobePrograms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UprobeProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(uprobeprogramsResource, name, pt, data, subresources...), &v1alpha1.UprobeProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.UprobeProgram), err
