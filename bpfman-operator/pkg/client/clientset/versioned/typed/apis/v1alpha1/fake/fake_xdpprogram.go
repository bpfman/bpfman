...
func (c *FakeXdpPrograms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.XdpProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(xdpprogramsResource, name), &v1alpha1.XdpProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.XdpProgram), err
}
...
func (c *FakeXdpPrograms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.XdpProgramList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(xdpprogramsResource, xdpprogramsKind, opts), &v1alpha1.XdpProgramList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.XdpProgramList{ListMeta: obj.(*v1alpha1.XdpProgramList).ListMeta}
	for _, item := range obj.(*v1alpha1.XdpProgramList).Items {
...
func (c *FakeXdpPrograms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(xdpprogramsResource, opts))
}
...
func (c *FakeXdpPrograms) Create(ctx context.Context, xdpProgram *v1alpha1.XdpProgram, opts v1.CreateOptions) (result *v1alpha1.XdpProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(xdpprogramsResource, xdpProgram), &v1alpha1.XdpProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.XdpProgram), err
...
func (c *FakeXdpPrograms) Update(ctx context.Context, xdpProgram *v1alpha1.XdpProgram, opts v1.UpdateOptions) (result *v1alpha1.XdpProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(xdpprogramsResource, xdpProgram), &v1alpha1.XdpProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.XdpProgram), err
...
func (c *FakeXdpPrograms) UpdateStatus(ctx context.Context, xdpProgram *v1alpha1.XdpProgram, opts v1.UpdateOptions) (*v1alpha1.XdpProgram, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(xdpprogramsResource, "status", xdpProgram), &v1alpha1.XdpProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.XdpProgram), err
...
func (c *FakeXdpPrograms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(xdpprogramsResource, name, opts), &v1alpha1.XdpProgram{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeXdpPrograms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(xdpprogramsResource, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.XdpProgramList{})
	return err
}
...
func (c *FakeXdpPrograms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.XdpProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(xdpprogramsResource, name, pt, data, subresources...), &v1alpha1.XdpProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.XdpProgram), err
