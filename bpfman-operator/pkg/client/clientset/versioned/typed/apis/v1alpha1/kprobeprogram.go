...
// KprobeProgramsGetter has a method to return a KprobeProgramInterface.
...
// kprobePrograms implements KprobeProgramInterface
...
func (c *kprobePrograms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KprobeProgram, err error) {
...
func (c *kprobePrograms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KprobeProgramList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KprobeProgramList{}
	err = c.client.Get().
		Resource("kprobeprograms").
...
func (c *kprobePrograms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kprobePrograms) Create(ctx context.Context, kprobeProgram *v1alpha1.KprobeProgram, opts v1.CreateOptions) (result *v1alpha1.KprobeProgram, err error) {
	result = &v1alpha1.KprobeProgram{}
	err = c.client.Post().
		Resource("kprobeprograms").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *kprobePrograms) Update(ctx context.Context, kprobeProgram *v1alpha1.KprobeProgram, opts v1.UpdateOptions) (result *v1alpha1.KprobeProgram, err error) {
	result = &v1alpha1.KprobeProgram{}
	err = c.client.Put().
		Resource("kprobeprograms").
...
func (c *kprobePrograms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kprobePrograms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kprobePrograms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KprobeProgram, err error) {
	result = &v1alpha1.KprobeProgram{}
