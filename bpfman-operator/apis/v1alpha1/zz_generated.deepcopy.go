...
func (in *FentryProgramStatus) DeepCopyInto(out *FentryProgramStatus) {
	*out = *in
	...
	if in.NodeStatus != nil {
		...
		*out = make([]NodeStatusEntry, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeStatusEntry) DeepCopyInto(out *NodeStatusEntry) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeStatusEntry.
func (in *NodeStatusEntry) DeepCopy() *NodeStatusEntry {
	if in == nil {
		return nil
	}
	out := new(NodeStatusEntry)
	in.DeepCopyInto(out)
	return out
}
