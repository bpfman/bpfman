...
func (r *UprobeProgramReconciler) getNodeStatus(ctx context.Context, prog client.Object) ([]bpfmaniov1alpha1.NodeStatusEntry, error) {
	//var ok bool

	program, ok := prog.(*bpfmaniov1alpha1.UprobeProgram)
	if !ok {
		return nil, fmt.Errorf("failed to cast program to UprobeProgram")
	}
