...
pub(crate) mod directories {
    ...
    // release tag, for example "v0.5.3". After release is made, the tag should
    // be changed back to the "latest" release tag.
    pub(crate) const XDP_DISPATCHER_IMAGE: &str = "quay.io/bpfman/xdp-dispatcher:v0.5.3";
    pub(crate) const TC_DISPATCHER_IMAGE: &str = "quay.io/bpfman/tc-dispatcher:v0.5.3";
