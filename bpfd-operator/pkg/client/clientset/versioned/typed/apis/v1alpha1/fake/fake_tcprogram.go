...
var tcprogramsResource = schema.GroupVersionResource{Group: "bpfd.io", Version: "v1alpha1", Resource: "tcprograms"}

var tcprogramsKind = schema.GroupVersionKind{Group: "bpfd.io", Version: "v1alpha1", Kind: "TcProgram"}
...
func (c *FakeTcPrograms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TcProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(tcprogramsResource, name), &v1alpha1.TcProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TcProgram), err
}
...
func (c *FakeTcPrograms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TcProgramList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(tcprogramsResource, tcprogramsKind, opts), &v1alpha1.TcProgramList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.TcProgramList{ListMeta: obj.(*v1alpha1.TcProgramList).ListMeta}
	for _, item := range obj.(*v1alpha1.TcProgramList).Items {
...
func (c *FakeTcPrograms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(tcprogramsResource, opts))
}
...
func (c *FakeTcPrograms) Create(ctx context.Context, tcProgram *v1alpha1.TcProgram, opts v1.CreateOptions) (result *v1alpha1.TcProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(tcprogramsResource, tcProgram), &v1alpha1.TcProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TcProgram), err
...
func (c *FakeTcPrograms) Update(ctx context.Context, tcProgram *v1alpha1.TcProgram, opts v1.UpdateOptions) (result *v1alpha1.TcProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(tcprogramsResource, tcProgram), &v1alpha1.TcProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TcProgram), err
...
func (c *FakeTcPrograms) UpdateStatus(ctx context.Context, tcProgram *v1alpha1.TcProgram, opts v1.UpdateOptions) (*v1alpha1.TcProgram, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(tcprogramsResource, "status", tcProgram), &v1alpha1.TcProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TcProgram), err
...
func (c *FakeTcPrograms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(tcprogramsResource, name, opts), &v1alpha1.TcProgram{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeTcPrograms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(tcprogramsResource, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TcProgramList{})
	return err
}
...
func (c *FakeTcPrograms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TcProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(tcprogramsResource, name, pt, data, subresources...), &v1alpha1.TcProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TcProgram), err
