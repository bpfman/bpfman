...
var tracepointprogramsResource = schema.GroupVersionResource{Group: "bpfd.io", Version: "v1alpha1", Resource: "tracepointprograms"}

var tracepointprogramsKind = schema.GroupVersionKind{Group: "bpfd.io", Version: "v1alpha1", Kind: "TracepointProgram"}
...
func (c *FakeTracepointPrograms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TracepointProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(tracepointprogramsResource, name), &v1alpha1.TracepointProgram{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeTracepointPrograms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TracepointProgramList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(tracepointprogramsResource, tracepointprogramsKind, opts), &v1alpha1.TracepointProgramList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeTracepointPrograms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(tracepointprogramsResource, opts))
}
...
func (c *FakeTracepointPrograms) Create(ctx context.Context, tracepointProgram *v1alpha1.TracepointProgram, opts v1.CreateOptions) (result *v1alpha1.TracepointProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(tracepointprogramsResource, tracepointProgram), &v1alpha1.TracepointProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TracepointProgram), err
...
func (c *FakeTracepointPrograms) Update(ctx context.Context, tracepointProgram *v1alpha1.TracepointProgram, opts v1.UpdateOptions) (result *v1alpha1.TracepointProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(tracepointprogramsResource, tracepointProgram), &v1alpha1.TracepointProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TracepointProgram), err
...
func (c *FakeTracepointPrograms) UpdateStatus(ctx context.Context, tracepointProgram *v1alpha1.TracepointProgram, opts v1.UpdateOptions) (*v1alpha1.TracepointProgram, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(tracepointprogramsResource, "status", tracepointProgram), &v1alpha1.TracepointProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TracepointProgram), err
...
func (c *FakeTracepointPrograms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(tracepointprogramsResource, name, opts), &v1alpha1.TracepointProgram{})
	return err
}
...
func (c *FakeTracepointPrograms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(tracepointprogramsResource, listOpts)
...
func (c *FakeTracepointPrograms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TracepointProgram, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(tracepointprogramsResource, name, pt, data, subresources...), &v1alpha1.TracepointProgram{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TracepointProgram), err
